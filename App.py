...
connection = pymysql.connect(host='localhost',port=8080,user='root',password='',db='sra',
                             connect_timeout=1000 )
# connection = pymysql.connect(host='localhost', port=8080, user='root', passwd='', db='sra', max_allowed_packet=16777216,
#                              connect_timeout=120
#                              )
#
